...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="grid md:grid-cols-3 md:gap-10 md:place-items-center mb-28 max-w-[80rem] text-center md:mb-0 scroll-mt-[100rem]"
    >
      <div className="relative mx-auto w-fit md:col-span-1">
        <motion.div
        ...
        >
          <Image
            ...
            quality="95"
            priority={true}
            className="h-48 w-48 md:h-80 md:w-80 rounded-full object-cover border-[0.35rem] border-white shadow-xl"
          />
        </motion.div>
      ...
      <div className="md:col-span-2">
        ...
        >
          <span className="font-bold">Hello, I'm Othavio.</span> I'm a{" "}
        ...
        >
          ...
          <div className="flex gap-3 ">
            <a
              ...
              href="https://www.linkedin.com/in/othavio-rubim/"
              target="_blank"
            >
              <BsLinkedin />
            </a>
